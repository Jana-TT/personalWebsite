...
export default function ContactMe() {
    return(
        ...
        <div className="overflow-visible flex space-x-3 container mx-auto mt-16 pl-48">
            <div>
            ...
            <div className="py-8 lg:py-16 px-4 mx-auto pr-40 whitespace-nowrap">
                ...
                <ContactInfoPng content="Jana-TT" pageLink="https://github.com/Jana-TT?tab=repositories%22%7D%3E%22%7D%3E" imageSource="/githublogo2.png" widthSize={26} heightSize={20}/>
